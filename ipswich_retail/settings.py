...
SECRET_KEY = 'django-insecure-*-e2%2@!iimlv-ga@d-c^&k+1m6%$_y%_scdfnnd=c7ia=dyf='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["ManiPython.pythonanywhere.com"]
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'products:product_admin'
